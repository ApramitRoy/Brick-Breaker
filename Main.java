...
class MapGenerator{
    ...
    //this creates the brick of size 3*7
    ...
    //this sets the value of brick to 0 if it is hit by ball
...
public void paint(Graphics g){
    ...
    g.setColor(Color.black);
    g.setFont(new Font("Droid Sans",Font.BOLD,25));
    ...
    if(ballposY>570){//if ball goes below the paddle then you lose
        ...
        ballYdir=0;
        g.setColor(Color.BLACK);
        g.setFont(new Font("Droid Sans", Font.BOLD,30));
    ...
    public void actionPerformed(ActionEvent arg0) {
        ...
        ballposX += ballXdir;
        ballposY += ballYdir;
        if(ballposX<0){ //if ball hits the left wall then bounces back
            ballXdir=-ballXdir;
        }
...
class Main{
    public static void main(String[] args) {
        ...
        obj.setTitle("Brick Braker 2024");
